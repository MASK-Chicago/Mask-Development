 ...
 * @since 1.0
 */
class FusionSC_FusionWooShortcodes {
		...
		fusion_builder_map( array(
			...
			'params'            => array(
				array(
					...
					'value'       => array(
						esc_attr__( 'Order tracking', 'fusion-builder' )            => '1',
						esc_attr__( 'Product price/cart button', 'fusion-builder' ) => '2',
						esc_attr__( 'Product by SKU/ID', 'fusion-builder' )         => '3',
						esc_attr__( 'Products by SKU/ID', 'fusion-builder' )        => '4',
						esc_attr__( 'Product categories', 'fusion-builder' )        => '5',
						esc_attr__( 'Products by category slug', 'fusion-builder' ) => '6',
						esc_attr__( 'Recent products', 'fusion-builder' )           => '7',
						esc_attr__( 'Featured products', 'fusion-builder' )         => '8',
						esc_attr__( 'Shop Message', 'fusion-builder' )              => '9',
					),
					'default'          => '',
